...
public class UIEntranceBreath : MonoBehaviour
{
    [Header("Entrance (From Left)")]
    public float enterDuration = 0.9f;
    public float enterOvershoot = 25f;     // pixels (small overshoot looks nice)
    public float startOffsetX = -900f;     // how far left to start (pixels)
    ...
    IEnumerator EnterThenBreath()
    {
        ...
        // Slide in with a soft ease + tiny overshoot
